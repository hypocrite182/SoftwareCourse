...
/**
 * Servlet implementation class Servlet_InsertStop
 */
@WebServlet("/Servlet_InsertStop")
public class Servlet_InsertStop extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Servlet_InsertStop() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		StopManage.insertStopInfo(stopInfo);
