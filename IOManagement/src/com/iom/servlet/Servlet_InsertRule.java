...
/**
 * Servlet implementation class Servlet_InsertRule
 */
@WebServlet("/Servlet_InsertRule")
public class Servlet_InsertRule extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Servlet_InsertRule() {
        super();
