...
/**
 * Servlet implementation class Servlet_UpdateRegist
 */
@WebServlet("/Servlet_UpdateRegist")
public class Servlet_UpdateRegist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Servlet_UpdateRegist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CarRegisterManage.updateRegistInfo(regist);
